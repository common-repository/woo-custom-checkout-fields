...
if ( ! function_exists( 'eswcfew_admin_form_field' ) ) {
	 ...
	 */
	function eswcfew_admin_form_field( $key, $args, $value = null ) {
		$defaults = array(
			'type'              => 'text',
			'label'             => '',
			'description'       => '',
	...
	switch ( $args['type'] ) {
		...
		case "country":
			...
			if ( sizeof( $countries ) == 1 ) {
				...
				$field = '<select  class="wcfew-country-select country_to_state country_select">
        ...
        case "wcfewselect" :
			...
			if ( ! empty( $optionsarray ) )
				...
				$field = '<select class="select wcfew-singleselect" style="width:200px;">
						' . $options . '
					</select>';
        break;
		...
		case "radio" :
	     ...
	     case "multiselect":
            ...
            if ( ! empty( $optionsarray ) ) {
             ...
             $field = '<select id="' . $key . '" class="select wcfew-multiselect" style="width:200px;" multiple="multiple">
                ' . $options . '
               </select>';
...
if ( ! function_exists( 'wcfew_get_woo_version_number' ) ) {
    ...
    function wcfew_get_woo_version_number() {
